...
*/
function filterFemale(objArray) {
  let newArray = [];
  for(let item of objArray){    
    if(isFemale(item)){
     newArray.push(item);
...
*/
function filterGradeA(objArray) {
  let newArray = [];
  for(let item of objArray){    
    if(isGradeA(item)){
     newArray.push(item);
...
*/
function filterGradeB(objArray) {
  let newArray = [];
  for(let item of objArray){    
    if(isGradeB(item)){
     newArray.push(item);
...
*/
function filterGradeC(objArray) {
  let newArray = [];
  for(let item of objArray){    
    if(isGradeC(item)){
     newArray.push(item);
