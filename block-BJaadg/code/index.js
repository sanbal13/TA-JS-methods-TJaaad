...
*/
for(let i=0; i < quoteSplitted.length; i++){
  if(quoteSplitted[i] === "today"){
    quoteSplitted[i] = "tomorrow";
  }
}
...
*/
let quotePadded = quote.padEnd(70, ".");
/*
16. Do same as (15) but the ... should come in start. Store the output in a new variable
*/
let quotePadBefore = quote.padStart(70, ".");
/*
